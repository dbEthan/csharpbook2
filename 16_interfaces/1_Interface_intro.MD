...
Vervolgens maken we een klasse die effectief die writer gebruikt. De truc zit hem er nu in dat deze klasse met ``IData`` werkt via compositie en dus niet weet naar waar alles zal geschreven worden. 

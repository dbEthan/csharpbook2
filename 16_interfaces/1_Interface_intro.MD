...
Je kan vervolgens volgens de compositie regels instellen welk object ``IData`` krijgt. In volgend voorbeeld stellen we dit in via de constructor, maar je zou ook van ``datadoel`` een property kunnen maken:
